...
![Рис.2: Установка Linux Fedora-35](image/"Рис2.png"){ #fig:001 width=100% }  
...
![Рис.3: Установка Linux Fedora-35](image/"Рис3.png"){ #fig:001 width=100% }  
* Укажите размер основной памяти виртуальной машины — от 2048 МБ(рис. [-@fig:004])  
![Рис.4: Установка Linux Fedora-35](image/"Рис4.png"){ #fig:001 width=100% }  
...
![Рис.5: Установка Linux Fedora-35](image/"Рис5.png"){ #fig:001 width=100% }  
...
![Рис.6: Установка Linux Fedora-35](image/"Рис6.png"){ #fig:001 width=100% }  
